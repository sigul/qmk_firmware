 ...
 */
    ...
    ESCFN,		KC_LCTL,	KC_LALT,	KC_LGUI,   	LOWER,	MT(MOD_LSFT, KC_TAB),	KC_SPC, RAISE,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
 ...
 * `-----------------------------------------------------------------------------------'
 */
    _______, DF(QWERTY), _______, EEP_RST, RESET,                      _______, _______, _______, _______, _______,
