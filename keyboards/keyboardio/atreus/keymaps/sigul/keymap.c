...
[BASE] = LAYOUT(
 	...
 	IT_Z,		ALG_X,		IT_C,		IT_V,		IT_B,		XXXXXXX,	XXXXXXX,	IT_N,		IT_M,		IT_CMLS,	IT_DTMR,	IT_SLQS,
 	XXXXXXX,	XXXXXXX,	XXXXXXX,	MED_ESC,	NAV_ENT,	MOU_TAB,	SYM_SPC,	NUM_BSP,	IT_SCCL,	XXXXXXX,	XXXXXXX,	XXXXXXX
  ),
