 ...
 */
    ...
    SFT_T(IT_Z),	IT_X,		IT_C,		IT_V,  			MS_B,			IT_SLQS,IT_SCCL,      	         IT_N,   IT_M,    IT_CMLS, IT_DTMR, KC_SFTENT,
    CTL_T(KC_ESC),	ALT_T(KC_TAB), 	KC_LGUI, 	SFT_T(KC_ESC),		LT(FN   ,KC_ENT), 	LT(LOWER,KC_TAB),       KC_SPC, LT(RAISE,KC_BSPC ), IT_SLQS, KC_DOWN, KC_UP,   KC_RGHT
),
 ...
 */
    ...
    KC_TAB ,  	_______, _______, RESET  , _______,                     _______, _______, _______, _______, KC_BSPC,
    _______,  	_______, _______, _______, _______,                     _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,
    _______,  	_______, _______, _______, _______, _______, _______, 	_______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R,
    _______,  	_______, _______, _______, KC_DEL, _______, IT_SCCL, 	KC_DEL , KC_BTN1, KC_BTN3, KC_BTN2,_______
),
 ...
 */
    ...
    G(IT_Z),  	G(IT_X), G(IT_V), G(IT_C), _______,_______, _______, 	_______, _______, _______, _______, _______,
